class SoundEffects {
    constructor() {
        this.shootSounds = [
            new Audio("/assets/audio/games/shoot.mp3"),
            new Audio("/assets/audio/games/shoot.mp3"),
            new Audio("/assets/audio/games/shoot.mp3"),
            new Audio("/assets/audio/games/shoot.mp3"),
            new Audio("/assets/audio/games/shoot.mp3"),
        ...
        this.hitSounds = [
            new Audio("/assets/audio/games/hit.mp3"),
            new Audio("/assets/audio/games/hit.mp3"),
            new Audio("/assets/audio/games/hit.mp3"),
            new Audio("/assets/audio/games/hit.mp3"),
            new Audio("/assets/audio/games/hit.mp3"),
        ...
        this.explosionSound = new Audio("/assets/audio/games/explosion.mp3");
        this.nextLevelSound = new Audio("/assets/audio/games/next_level.mp3");
